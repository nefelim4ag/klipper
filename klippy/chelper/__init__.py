...
SOURCE_FILES = [
    ...
    'kin_extruder.c', 'kin_shaper.c', 'kin_idex.c', 'kin_shaper_stepper.c'
]
...
defs_kin_shaper_stepper = """
    int stepper_set_shaper_params(uint32_t oid, int mscnt, int msteps,
                                  int period, int offset, float rotations,
                                  int amplitude);
...
defs_all = [
    ...
    defs_kin_extruder, defs_kin_shaper, defs_kin_idex, defs_kin_shaper_stepper
]
