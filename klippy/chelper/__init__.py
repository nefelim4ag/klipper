...
SOURCE_FILES = [
    ...
    'integrate.c', 'stepcorr.c', 'offload_worker.c'
]
DEST_LIB = "c_helper.so"
OTHER_FILES = [
    'list.h', 'serialqueue.h', 'stepcompress.h', 'itersolve.h', 'pyhelper.h',
    'trapq.h', 'pollreactor.h', 'msgblock.h', 'integrate.h', 'stepcorr.h'
]
...
defs_all = [
    ...
    defs_kin_generic_cartesian, defs_stepcorr, defs_offload_worker,
]
