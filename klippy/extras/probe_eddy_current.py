...
class EddyCalibration:
    def __init__(self, config):
        ...
        gcode.register_mux_command('PROBE_EDDY_CURRENT_CALIBRAION_OFFSET',
                                    "CHIP", cname,
                                    self.cmd_CALIBRAION_OFFSET,
                                    desc=self.cmd_CALIBRAION_OFFSET_help)
    ...
    def cmd_Z_OFFSET_APPLY_PROBE(self, gcmd):
        ...
        self._save_calibration(z_freq_pairs)
    cmd_CALIBRAION_OFFSET_help = "Runtime curve height adjustment"
    def cmd_CALIBRAION_OFFSET(self, gcmd):
