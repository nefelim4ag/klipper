...
def main():
    ...
    # Custom table PoC
    sin_value = [
         0,  2,  4,  7,  9, 11, 13, 15, # 0..8
        16, 18, 20, 22, 24, 26, 28, 30, # 9..16
        32, 34, 36, 37, 39, 41, 43, 45, # 17..24
        46, 48, 50, 51, 53, 55, 57, 59, # 25..32
        61, 62, 63, 65, 66, 68, 70, 71, # 33..40
        73, 75, 76, 77, 79, 81, 83, 84, # 41..48
        86, 87, 89, 90, 92, 93, 94, 96, # 49..56

         98,  99, 100, 101,  103, 104, 106, 107, # 57..64
        109, 110, 112, 114,  116, 118, 120, 121, # 65..72
        123, 125, 127, 128,  129, 130, 131, 133, # 73..80
        134, 136, 138, 140,  141, 142, 143, 145, # 81..88
        146, 147, 148, 150,  151, 152, 153, 154, # 89..96
        156, 158, 160, 162,  163, 165, 167, 169, # 97..104
        170, 172, 174, 176,  178, 180, 182, 184, # 105..112
        186, 187, 188, 190,  191, 192, 193, 194, # 113..120
        194, 195, 196, 197,  198, 199, 200, 201, # 121..128
        202, 203, 204, 205,  206, 207, 208, 208, # 129..136
        209, 209, 210, 210,  210, 211, 212, 212, # 137..144
        213, 213, 214, 214,  215, 215, 215, 215, # 145..152
        216, 216, 216, 217,  217, 217, 218, 218, # 153..160
        218, 219, 219, 219,  220, 220, 220, 220, # 161..168
        221, 221, 221, 221,  222, 222, 222, 222, # 169..176
        223, 223, 223, 223,  224, 224, 224, 224, # 177..184
        225, 225, 225, 225,  225, 226, 227, 227, # 185..192
    ...
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT0 VALUE={new["MSLUTS"][0]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT1 VALUE={new["MSLUTS"][1]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT2 VALUE={new["MSLUTS"][2]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT3 VALUE={new["MSLUTS"][3]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT4 VALUE={new["MSLUTS"][4]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT5 VALUE={new["MSLUTS"][5]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT6 VALUE={new["MSLUTS"][6]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=MSLUT7 VALUE={new["MSLUTS"][7]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=W0 VALUE={new["W"][0]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=W1 VALUE={new["W"][1]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=W2 VALUE={new["W"][2]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=W3 VALUE={new["W"][3]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=X1 VALUE={new["X"][1]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=X2 VALUE={new["X"][2]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=X3 VALUE={new["X"][3]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=START_SIN VALUE={new["START_SIN"]}")
    print(f"SET_TMC_FIELD STEPPER=stepper_x FIELD=START_SIN90 VALUE={new["START_SIN90"]}")
